...
@section('content')
    <section class="about-hero bg-gradient-to-br from-pj-blue-2 to-pj-purple text-pj-white py-16 px-0 text-center">
        <div class="container">
            <h2 class="text-5xl mb-4 font-grotesk font-bold">A propos de MonSite</h2>
            <p class="font-fira font-medium">Découvrez notre histoire et notre mission</p>
        </div>
    </section>
    ...
    <section class="about-content py-16 px-0">
        <div class="container">
            <div class="about-section bg-pj-white p-10 mb-12 rounded-lg shadow-md">
                <h2 class="text-pj-blue mb-6 text-3xl font-grotesk font-bold">Notre Histoire</h2>
                <div class="flex flex-col gap-4">
                    <p class="leading-7 text-pj-greyblue">
            ...
            <div class="about-section bg-pj-white p-10 mb-12 rounded-lg shadow-md">
                <h2 class="text-pj-blue mb-6 text-3xl font-grotesk font-bold">Notre Mission</h2>
                <div class="flex flex-col gap-4">
                    <p class="leading-7 text-pj-greyblue">
            ...
            <div class="values-section mb-12">
                <h2 class="text-center text-4xl mb-12 text-pj-greyblue font-grotesk font-semibold">Nos Valeurs</h2>
                <div class="values-grid grid [grid-template-columns:repeat(auto-fit,minmax(250px,1fr))] gap-8">
                    <div class="value-card bg-pj-white p-8 rounded-lg shadow-md text-center transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
                        ...
                        <p class="text-pj-greyblue leading-6">Nous visons l'excellence dans tout ce que nous faisons,
                            de la conception à l'expérience utilisateur.</p>
                    </div>
                    <div class="value-card bg-pj-white p-8 rounded-lg shadow-md text-center transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
                        <div class="value-icon text-4xl mb-4">🔒</div>
                        <h3 class="text-pj-blue mb-4 font-semibold">Sécurité</h3>
                        <p class="text-pj-greyblue leading-6">La protection de vos données est notre priorité absolue.
                            Nous utilisons les dernières technologies de sécurité.</p>
                    </div>
                    <div class="value-card bg-pj-white p-8 rounded-lg shadow-md text-center transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
                        <div class="value-icon text-4xl mb-4">💡</div>
                        <h3 class="text-pj-blue mb-4 font-semibold">Innovation</h3>
                        <p class="text-pj-greyblue leading-6">Nous innovons constamment pour vous offrir les meilleures
                            fonctionnalités et rester à la pointe de la technologie.</p>
                    </div>
                    <div class="value-card bg-pj-white p-8 rounded-lg shadow-md text-center transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
                        <div class="value-icon text-4xl mb-4">🤝</div>
                        <h3 class="text-pj-blue mb-4 font-semibold">Communauté</h3>
                        <p class="text-pj-greyblue leading-6">Nous valorisons notre communauté d'utilisateurs et écoutons
            ...
            <div class="team-section mb-12">
                <h2 class="text-center text-4xl mb-12 text-pj-greyblue font-grotesk font-semibold">Notre Equipe</h2>
            ...
            <div class="stats-section mb-12">
                <h2 class="text-center text-4xl mb-12 text-pj-greyblue font-grotesk font-semibold">Quelques Chiffres</h2>
            ...
            <div class="about-cta bg-gradient-to-br from-pj-blue-2 to-pj-purple text-pj-white p-12 rounded-lg text-center">
                <h2 class="text-4xl mb-4 font-grotesk font-bold">Rejoignez-nous dès aujourd'hui</h2>
                <p class="text-lg mb-8">Faites partie de notre communauté grandissante</p>
