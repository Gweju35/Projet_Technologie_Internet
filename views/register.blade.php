...
@section('content')
    ...
    <div class="container">
        <div class="auth-box bg-pj-white max-w-lg my-0 mx-auto p-12 rounded-lg shadow-md">
            <h2 class="text-center text-pj-greyblue mb-8">Créer un compte</h2>
            <form id="registerForm" class="auth-form flex flex-col gap-6">
                <div class="form-group flex flex-col">
                    ...
                    <input type="text" id="username" name="username" required class="p-3 border border-solid border-pj-white text-base rounded-md focus:outline-none focus:border-pj-blue">
                ...
                <div class="form-group flex flex-col">
                    ...
                    <small class="text-pj-grey text-sm mt-1">Minimum 8 caractères, incluant lettres et chiffres</small>
                </div>

                <div class="form-group flex flex-col">
                    <label for="confirmPassword" class="mb-2 font-semibold text-pj-greyblue">Confirmer le mot de passe</label>
                    <input type="password" id="confirmPassword" name="confirmPassword" required class="p-3 border border-solid border-pj-white text-base rounded-md focus:outline-none focus:border-pj-blue">
