...
@section('content')
    ...
    <div class="container">
        <div class="auth-box bg-pj-white max-w-lg my-0 mx-auto p-8 md:p-12 rounded-lg shadow-md">
            ...
            <form id="registerForm" class="auth-form flex flex-col gap-4 md:gap-6">
                <div class="form-group flex flex-col">
                    <label for="username" class="mb-2 font-semibold text-pj-greyblue text-sm md:text-base">Nom d'utilisateur</label>
                    <input type="text" id="username" name="username" required class="p-1.5 md:p-3 border border-solid border-black/15 text-base rounded-md focus:outline-none focus:border-pj-blue">
